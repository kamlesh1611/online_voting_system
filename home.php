				    ...
				    <?php
				    	...
				    	if($vquery->num_rows > 0){
				    		...
				    		<div class="text-center" style="color:black ; font-size: 35px; font-family:Times" >
					    		...
					    		<a href="#view" data-toggle="modal" class="btn btn-curve btn-primary btn-lg" style="background-color: #202020 ;color: #fca311 ; font-size: 22px; font-family:Times">View Ballot</a>
					    	</div>
				    		<?php
				    	}
				    	else{
				        		...
				        		<?php
									...
									while($row = $query->fetch_assoc()){
										...
										echo '
											<div class="row">
												<div class="col-xs-12">
													<div class="box box-solid" style="background-color: #202020; color: #e5e5e5; id="'.$row['id'].'">
														<div class="box-header with-border" style="background-color: #202020">
															<h3 class="box-title" style="color: #fca311;"><b>'.$row['description'].'</b></h3>
														</div>
														<div class="box-body" >
															<p>'.$instruct.'
