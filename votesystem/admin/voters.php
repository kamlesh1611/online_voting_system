        ...
        <div class="col-xs-12" >
          <div class="box" style="background-color: #202020; color: #e5e5e5;">
            <div class="box-header with-border" style="background-color: #202020;">
              <a href="#addnew" data-toggle="modal" class="btn btn-primary btn-sm btn-curve " style="background-color: #4682B4 ;color: #e5e5e5 ; font-size: 12px; font-family:Times"><i class="fa fa-plus"></i> New</a>
            </div>
            <div class="box-body">
              <table id="example1" class="table" style="color: #fca311;">
                <thead>
                  <th>Lastname</th>
                  <th>Firstname</th>
                  <th>Photo</th>
