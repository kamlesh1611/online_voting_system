<header class="main-header" style="background-color: #202020 " >
  <!-- Logo -->
  <a href="#" class="logo " style="background-color: #202020">
    <!-- mini logo for sidebar mini 50x50 pixels -->
    <span class="logo-mini" style="background-color: #202020 "><b>BB</b>OVS</span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg " style="background-color: #202020 ; color: #E5E5E5 ; font-size: 22px; font-family:Times  "><marquee behavior="scroll" direction="left">SmartPolling Online Voting System</marquee></span>
    ...
    <div class="navbar-custom-menu" style="color:black ; font-size: 17px; font-family:Times">
      <ul class="nav navbar-nav" style="background-color: #717A83 ;color:black ; font-size: 17px; font-family:Times" >
        ...
        <li class="dropdown user user-menu  " style="color:black">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="background-color: #202020 ;color:white ; font-size: 17px; font-family:Times" >
