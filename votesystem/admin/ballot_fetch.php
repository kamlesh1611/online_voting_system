<?php
	...
	while($row = $query->fetch_assoc()){
		...
		while($crow = $cquery->fetch_assoc()){
			...
			$candidate .= '
				<li>
					'.$input.'<button class="btn btn-primary btn-sm btn-curve clist" style="background-color: #fca311 ;color: #202020 ; font-size: 12px; font-family:Times"><i class="fa fa-search"></i> Platform</button><img src="'.$image.'" height="100px" width="100px" class="clist"><span class="cname clist">'.$crow['firstname'].' '.$crow['lastname'].'</span>
				</li>
			';
		}
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="box box-solid" style="background-color: #202020; color: #e5e5e5; id="'.$row['id'].'">
						<div class="box-header with-border" style="background-color: #202020; color: #fca311;">
